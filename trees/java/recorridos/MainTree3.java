...
public class MainTree3 {
  public static void main(String[] args) {
    ...
    System.out.println(objTree3.preorder());
    System.out.println(objTree3.inorder());
    System.out.println(objTree3.posorder());
